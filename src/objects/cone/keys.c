...
/*   Updated: 2025/05/31 18:15:54 by lroussel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void	update_size(t_cone *cone, float incrementation)
{
	...
	base_diameter = cone->base_diameter;
	if (base_diameter + incrementation <= 0.0f)
		return ;
	scale_factor = (base_diameter + incrementation) / base_diameter;
	cone->base_diameter *= scale_factor;
