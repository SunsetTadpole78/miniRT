...
declare -A expected_errors=(
	...
	["too_few_args_pl.rt"]="Plane format: 'pl <position> <normal> <color> [<pattern> [color2]] [<smoothness> [mattifying]]'"
	...
	["too_many_args_pl.rt"]="Plane format: 'pl <position> <normal> <color> [<pattern> [color2]] [<smoothness> [mattifying]]'"
	...
	["too_few_args_sp.rt"]="Sphere format: 'sp <position> <diameter> <color> [<pattern> [color2]] [<smoothness> [mattifying]]'"
	...
	["too_many_args_sp.rt"]="Sphere format: 'sp <position> <diameter> <color> [<pattern> [color2]] [<smoothness> [mattifying]]'"
	...
	["too_few_args_cy.rt"]="Cylinder format: 'cy <position> <normal> <diameter> <height> <color> [<pattern> [color2]] [<smoothness> [mattifying]]'"
	...
	["too_many_args_cy.rt"]="Cylinder format: 'cy <position> <normal> <diameter> <height> <color> [<pattern> [color2]] [<smoothness> [mattifying]]'"
