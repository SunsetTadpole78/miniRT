...
/*   Updated: 2025/06/01 20:44:06 by lroussel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define PL_ARGS_E "Plane format: 'pl <position> <normal> <rgb|texture> [<pattern>\
...
or path.xpm\n"
# define SP_ARGS_E "Sphere format: 'sp <position> <diameter> <rgb|texture> [<pattern>\
 [color2]] [<smoothness> [mattifying]]'\n"
...
<rgb|texture> [<pattern> [color2]] [<smoothness> [mattifying]]'\n"
